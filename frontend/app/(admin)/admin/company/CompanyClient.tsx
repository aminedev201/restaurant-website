...
import { Building2, Pencil, MapPin, Phone, Mail, Clock, Camera, X, Upload, ImageOff, ZoomIn, ChevronDown } from 'lucide-react';
...
export default function CompanyClient() {
  ...
  // Logo state — mirrors ProfileClient avatar pattern
        ...
        {!loading && company && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="col-span-full bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5 flex flex-col items-center gap-5">
              ...
              {/* ── Logo with camera controls (mirrors ProfileClient avatar) ── */}
