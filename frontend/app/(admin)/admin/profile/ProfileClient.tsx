...
import {
    User as UserIcon, Mail, Phone, ShieldCheck, Calendar, Clock,
...
import ChangeProfilePasswordModal from '@/components/admin/profile/ChangeProfilePasswordModal';
import DeleteAccountModal from '@/components/admin/profile/DeleteAccountModal';
        ...
        <>
            ...
            <div className="">
                ...
                <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 overflow-hidden">
                    ...
                    {/* Banner */}
                    <div className="relative h-36 bg-gradient-to-br from-amber-500/20 via-amber-400/10 to-transparent dark:from-amber-900/40 dark:via-amber-900/20 dark:to-transparent flex items-center justify-center">
                        ...
                        <div className="relative z-10 flex flex-col items-center gap-2">
                            ...
                            <div className="relative group">
                                {avatarPreview ? (
                                    ...
                                    <div className="w-20 h-20 rounded-2xl bg-amber-500 flex items-center justify-center border-4 border-white dark:border-gray-900 shadow-xl">
                            ...
                            {avatarPreview && (
                                <div className="flex items-center gap-2">
                                    ...
                                    <button
                                        ...
                                        disabled={avatarUploading}
                                        className="flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-semibold text-white bg-amber-500 hover:bg-amber-600 transition-colors disabled:opacity-60"
                                    >
                                        {avatarUploading ? (
                    ...
                    <div className="px-6 pt-4 pb-2">
                        ...
                        <span className="inline-flex items-center gap-1 mt-1 px-2.5 py-1 rounded-lg bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400 text-xs font-semibold capitalize">
