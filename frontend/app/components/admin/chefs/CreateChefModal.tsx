...
import { chefApi } from '@/lib/adminServiceApi';
...
export default function CreateChefModal({ open, onClose, onSuccess }: Props) {
  ...
  const handleClose = () => {
    setFullname(''); setPosition(''); setShortDesc(''); setStatus(true);
    setSocial({ facebook: '', instagram: '', twitter: '', youtube: '', linkedin: '' });
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-2xl bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-800 flex flex-col max-h-[90vh]">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-800 shrink-0">
            <h2 className="font-bold text-lg text-gray-900 dark:text-white">Add Chef</h2>
          ...
          <div className="overflow-y-auto flex-1">
            <form onSubmit={handleSubmit} id="create-chef-form" className="p-6 space-y-5">
              {errors.api && (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" value={fullname} onChange={e => setFullname(e.target.value)} placeholder="e.g. John Smith" className={inputCls('fullname')} />
                ...
                <div>
                  ...
                  <input type="text" value={position} onChange={e => setPosition(e.target.value)} placeholder="e.g. Head Chef" className={inputCls('position')} />
              ...
              <div>
                ...
                <textarea rows={3} value={shortDesc} onChange={e => setShortDesc(e.target.value)} placeholder="Brief bio..." className={`${inputCls('short_desc')} resize-none`} />
              ...
              {/* Image */}
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Photo <span className="text-red-500">*</span></label>
          ...
          <div className="flex gap-3 px-6 py-4 border-t border-gray-100 dark:border-gray-800 shrink-0">
            ...
            <button type="submit" form="create-chef-form" disabled={loading}
